...
b(a,"Extensions/Debugger/Debugger.js",[a["Extensions/Debugger/ErrorMessages.js"],a["Core/Globals.js"],a["Core/DefaultOptions.js"],a["Core/Utilities.js"]],function(a,c,b,f){function h(){var a=this.errorElements;if(a&&a.length)for(var d=0;d<a.length;d++)a[d].destroy();delete this.errorElements}function m(b){var d=b.chart||n(this.charts.slice().reverse(),function(a){return!!a});if(d){var c=b.code,e=d.options.chart;b=d.renderer;if(d.errorElements){var g=0;for(var f=d.errorElements;g<f.length;g++){var h=
f[g];h&&h.destroy()}}e&&e.displayErrors&&b&&(d.errorElements=[],c=p(c)?"Highcharts error #"+c+": "+a[c].text:c,e=d.chartWidth,g=d.chartHeight,c=c.replace(/<h1>(.*)<\/h1>/g,'<br><span style="font-size: 24px">$1</span><br>').replace(/<p>/g,"").replace(/<\/p>/g,"<br>"),d.errorElements[0]=b.rect(2,2,e-4,g-4).attr({"stroke-width":4,stroke:"#ff0000",zIndex:3}).add(),d.errorElements[1]=b.label(c,0,0,"rect",void 0,void 0,void 0,void 0,"debugger").css({color:"#ffffff",width:e-16+"px",padding:0}).attr({fill:"rgba(255, 0, 0, 0.9)",
