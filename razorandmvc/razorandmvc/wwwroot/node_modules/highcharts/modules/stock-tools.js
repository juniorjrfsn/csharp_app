...
this.boundClassNames=void 0;this.chart=a;this.options=c;this.eventsToUnbind=[];this.container=this.chart.container.querySelectorAll("."+this.options.bindingsClassName);this.container.length||(this.container=t.querySelectorAll("."+this.options.bindingsClassName))}d.compose=function(b,k){-1===A.indexOf(b)&&(A.push(b),u(b,"remove",r),c(b),z(b.types,function(a){c(a)}));-1===A.indexOf(k)&&(A.push(k),u(k,"destroy",x),u(k,"load",g),u(k,"render",p));-1===A.indexOf(d)&&(A.push(d),u(d,"closePopup",l),u(d,"deselectButton",
a));-1===A.indexOf(e)&&(A.push(e),e(f))};d.prototype.initEvents=function(){var a=this,c=a.chart,b=a.container,e=a.options;a.boundClassNames={};z(e.bindings||{},function(c){a.boundClassNames[c.className]=c});[].forEach.call(b,function(c){a.eventsToUnbind.push(u(c,"click",function(b){var e=a.getButtonEvents(c,b);e&&-1===e.button.className.indexOf("highcharts-disabled-btn")&&a.bindingsButtonClick(e.button,e.events,b)}))});z(e.events||{},function(c,b){J(c)&&a.eventsToUnbind.push(u(a,b,c,{passive:!1}))});
a.eventsToUnbind.push(u(c.container,"click",function(b){!c.cancelClick&&c.isInsidePlot(b.chartX-c.plotLeft,b.chartY-c.plotTop,{visiblePlotOnly:!0})&&a.bindingsChartClick(this,b)}));a.eventsToUnbind.push(u(c.container,q.isTouchDevice?"touchmove":"mousemove",function(c){a.bindingsContainerMouseMove(this,c)},q.isTouchDevice?{passive:!1}:void 0))};d.prototype.initUpdate=function(){var a=this;b.compose(this.chart).navigation.addUpdate(function(c){a.update(c)})};d.prototype.bindingsButtonClick=function(a,
c,b){var e=this.chart,k=e.renderer.boxWrapper,d=!0;this.selectedButtonElement&&(this.selectedButtonElement.classList===a.classList&&(d=!1),B(this,"deselectButton",{button:this.selectedButtonElement}),this.nextEvent&&(this.currentUserDetails&&"annotations"===this.currentUserDetails.coll&&e.removeAnnotation(this.currentUserDetails),this.mouseMoveEvent=this.nextEvent=!1));d?(this.selectedButton=c,this.selectedButtonElement=a,B(this,"selectButton",{button:a}),c.init&&c.init.call(this,a,b),(c.start||c.steps)&&
e.renderer.boxWrapper.addClass("highcharts-draw-mode")):(e.stockTools&&e.stockTools.toggleButtonActiveClass(a),k.removeClass("highcharts-draw-mode"),this.mouseMoveEvent=this.nextEvent=!1,this.selectedButton=null)};d.prototype.bindingsChartClick=function(a,c){a=this.chart;var b=this.activeAnnotation,e=this.selectedButton;a=a.renderer.boxWrapper;b&&(b.cancelClick||c.activeAnnotation||!c.target.parentNode||w(c.target,".highcharts-popup")?b.cancelClick&&setTimeout(function(){b.cancelClick=!1},0):B(this,
...
typeHLC:{symbol:"series-hlc.svg"},typeHeikinAshi:{symbol:"series-heikin-ashi.svg"},typeHollowCandlestick:{symbol:"series-hollow-candlestick.svg"}},fullScreen:{symbol:"fullscreen.svg"},saveChart:{symbol:"save-chart.svg"}}}}}});r(b,"Stock/StockTools/StockTools.js",[b["Core/DefaultOptions.js"],b["Extensions/Annotations/NavigationBindingsUtilities.js"],b["Stock/StockTools/StockToolsBindings.js"],b["Stock/StockTools/StockToolsDefaults.js"],b["Stock/StockTools/StockToolsUtilities.js"],b["Core/Utilities.js"]],
