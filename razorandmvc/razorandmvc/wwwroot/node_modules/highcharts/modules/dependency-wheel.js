...
null],curveFactor:.6,startAngle:0}});c(b,"Series/DependencyWheel/DependencyWheelSeries.js",[b["Core/Animation/AnimationUtilities.js"],b["Series/DependencyWheel/DependencyWheelPoint.js"],b["Series/DependencyWheel/DependencyWheelSeriesDefaults.js"],b["Core/Globals.js"],b["Series/Sankey/SankeyColumnComposition.js"],b["Core/Series/SeriesRegistry.js"],b["Core/Utilities.js"]],function(b,c,r,g,t,e,a){var f=this&&this.__extends||function(){var b=function(a,c){b=Object.setPrototypeOf||{__proto__:[]}instanceof
Array&&function(b,a){b.__proto__=a}||function(b,a){for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c])};return b(a,c)};return function(a,c){function q(){this.constructor=a}b(a,c);a.prototype=null===c?Object.create(c):(q.prototype=c.prototype,new q)}}(),u=b.animObject,v=g.deg2rad;g=e.seriesTypes;b=g.pie;var n=g.sankey;g=a.extend;var k=a.merge;a=function(b){function a(){var a=null!==b&&b.apply(this,arguments)||this;a.data=void 0;a.options=void 0;a.nodeColumns=void 0;a.nodes=void 0;a.points=void 0;return a}
f(a,b);a.prototype.animate=function(a){if(!a){var b=u(this.options.animation).duration/2/this.nodes.length;this.nodes.forEach(function(a,c){var e=a.graphic;e&&(e.attr({opacity:0}),setTimeout(function(){a.graphic&&a.graphic.animate({opacity:1},{duration:b})},b*c))},this);this.points.forEach(function(a){var b=a.graphic;!a.isNode&&b&&b.attr({opacity:0}).animate({opacity:1},this.options.animation)},this)}};a.prototype.createNode=function(a){var b=n.prototype.createNode.call(this,a);b.getSum=function(){return b.linksFrom.concat(b.linksTo).reduce(function(b,
a){return b+a.weight},0)};b.offset=function(a){function c(a){return a.fromNode===b?a.toNode:a.fromNode}var e=0,d,h=b.linksFrom.concat(b.linksTo);h.sort(function(a,b){return c(a).index-c(b).index});for(d=0;d<h.length;d++)if(c(h[d]).index>b.index){h=h.slice(0,d).reverse().concat(h.slice(d).reverse());var f=!0;break}f||h.reverse();for(d=0;d<h.length;d++){if(h[d]===a)return e;e+=h[d].weight}};return b};a.prototype.createNodeColumns=function(){var a=[t.compose([],this)];this.nodes.forEach(function(b){b.column=
0;a[0].push(b)});return a};a.prototype.getNodePadding=function(){return this.options.nodePadding/Math.PI};a.prototype.translate=function(){var a=this.options,b=2*Math.PI/(this.chart.plotHeight+this.getNodePadding()),c=this.getCenter(),e=(a.startAngle-90)*v;n.prototype.translate.call(this);this.nodeColumns[0].forEach(function(f){if(f.sum){var d=f.shapeArgs,h=c[0],g=c[1],k=c[2]/2,l=k-a.nodeWidth,m=e+b*(d.y||0);d=e+b*((d.y||0)+(d.height||0));f.angle=m+(d-m)/2;f.shapeType="arc";f.shapeArgs={x:h,y:g,r:k,
innerR:l,start:m,end:d};f.dlBox={x:h+Math.cos((m+d)/2)*(k+l)/2,y:g+Math.sin((m+d)/2)*(k+l)/2,width:1,height:1};f.linksFrom.forEach(function(c){if(c.linkBase){var f,d=c.linkBase.map(function(d,k){d*=b;var m=Math.cos(e+d)*(l+1),n=Math.sin(e+d)*(l+1),p=a.curveFactor||0;f=Math.abs(c.linkBase[3-k]*b-d);f>Math.PI&&(f=2*Math.PI-f);f*=l;f<l&&(p*=f/l);return{x:h+m,y:g+n,cpX:h+(1-p)*m,cpY:g+(1-p)*n}});c.shapeArgs={d:[["M",d[0].x,d[0].y],["A",l,l,0,0,1,d[1].x,d[1].y],["C",d[1].cpX,d[1].cpY,d[2].cpX,d[2].cpY,
d[2].x,d[2].y],["A",l,l,0,0,1,d[3].x,d[3].y],["C",d[3].cpX,d[3].cpY,d[0].cpX,d[0].cpY,d[0].x,d[0].y]]}}})}})};a.defaultOptions=k(n.defaultOptions,r);return a}(n);g(a.prototype,{orderNodes:!1,getCenter:b.prototype.getCenter});a.prototype.pointClass=c;e.registerSeriesType("dependencywheel",a);return a});c(b,"masters/modules/dependency-wheel.src.js",[],function(){})});
