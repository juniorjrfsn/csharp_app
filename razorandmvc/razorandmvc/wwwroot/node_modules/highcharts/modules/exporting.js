...
M=function(a){a&&a.stopPropagation();b.call(c,a)}:d&&(M=function(a){a&&a.stopPropagation();c.contextMenu(r.menuClassName,d,r.translateX,r.translateY,r.width,r.height,r);r.setState(2)});k.text&&k.symbol?f.paddingLeft=x(f.paddingLeft,30):k.text||F(f,{width:k.width,height:k.height,padding:0});c.styledMode||(f["stroke-linecap"]="round",f.fill=x(f.fill,"#ffffff"),f.stroke=x(f.stroke,"none"));var r=y.button(k.text,0,0,M,f).addClass(a.className).attr({title:x(c.options.lang[k._titleKey||k.titleKey],"")});
