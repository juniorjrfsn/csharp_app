/*
 Highcharts Stock JS v10.2.1 (2022-09-19)
...
(k/e-1))*100;a.push([c]);c=h;g=k}return a};e.prototype.getEMA=function(a,d,f,e,g,c,h){return q.prototype.calculateEma(h||[],a,"undefined"===typeof c?1:c,e,d,"undefined"===typeof g?-1:g,f)};e.prototype.getSMA=function(a,d,f){return q.prototype.accumulatePeriodPoints(a,d,f)/a};e.prototype.getValues=function(a,d){var b=[],e=a.xData;a=a.yData;var g=[],c=[],h=[],k,l=0,m=0,q=void 0,r=void 0,z=null;if(this.isValidData(a[0])){var n=this.getVolumeForce(a),w=this.getSMA(d.fastAvgPeriod,0,n),u=this.getSMA(d.slowAvgPeriod,
...
signalLine:{styles:{lineWidth:1,lineColor:"#ff0000"}},dataGrouping:{approximation:"averages"},tooltip:{pointFormat:'<span style="color: {point.color}">\u25cf</span><b> {series.name}</b><br/><span style="color: {point.color}">Klinger</span>: {point.y}<br/><span style="color: {point.series.options.signalLine.styles.lineColor}">Signal</span>: {point.signal}<br/>'}});return e}(l);m(g.prototype,{areaLinesNames:[],linesApiNames:["signalLine"],nameBase:"Klinger",nameComponents:["fastAvgPeriod","slowAvgPeriod"],
