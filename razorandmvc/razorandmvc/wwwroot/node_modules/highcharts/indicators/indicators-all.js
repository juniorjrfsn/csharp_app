...
f["Core/Utilities.js"]],function(f,e,h,k){function n(a){return a.reduce(function(a,b){return Math.max(a,b[1])},-Infinity)}function q(a){return a.reduce(function(a,b){return Math.min(a,b[2])},Infinity)}function p(a){return{high:n(a),low:q(a)}}function g(a){var b,c,l,d,g;a.series.forEach(function(a){if(a.xData)for(d=a.xData,g=c=a.xIncrement?1:d.length-1;0<g;g--)if(l=d[g]-d[g-1],"undefined"===typeof b||l<b)b=l});return b}function d(a,b,c,l){if(a&&b&&c&&l){var d=b.plotX-a.plotX;b=b.plotY-a.plotY;var g=
l.plotX-c.plotX;l=l.plotY-c.plotY;var e=a.plotX-c.plotX,v=a.plotY-c.plotY;c=(-b*e+d*v)/(-g*b+d*l);g=(g*v-l*e)/(-g*b+d*l);if(0<=c&&1>=c&&0<=g&&1>=g)return{plotX:a.plotX+g*d,plotY:a.plotY+g*b}}return!1}function a(a){var b=a.indicator;b.points=a.points;b.nextPoints=a.nextPoints;b.color=a.color;b.options=w(a.options.senkouSpan.styles,a.gap);b.graph=a.graph;b.fillGraph=!0;h.seriesTypes.sma.prototype.drawGraph.call(b)}var c=this&&this.__extends||function(){var a=function(b,c){a=Object.setPrototypeOf||{__proto__:[]}instanceof
Array&&function(a,b){a.__proto__=b}||function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])};return a(b,c)};return function(b,c){function l(){this.constructor=b}a(b,c);b.prototype=null===c?Object.create(c):(l.prototype=c.prototype,new l)}}(),b=f.parse,l=h.seriesTypes.sma,v=k.defined;f=k.extend;var B=k.isArray,z=k.isNumber,w=k.merge,N=k.objectEach;e.approximations["ichimoku-averages"]=function(){var a=[],b;[].forEach.call(arguments,function(c,l){a.push(e.approximations.average(c));b=!b&&"undefined"===
typeof a[l]});return b?void 0:a};k=function(e){function f(){var a=null!==e&&e.apply(this,arguments)||this;a.data=void 0;a.options=void 0;a.points=void 0;a.graphCollection=void 0;a.graphsenkouSpan=void 0;a.ikhMap=void 0;a.nextPoints=void 0;return a}c(f,e);f.prototype.init=function(){h.seriesTypes.sma.prototype.init.apply(this,arguments);this.options=w({tenkanLine:{styles:{lineColor:this.color}},kijunLine:{styles:{lineColor:this.color}},chikouLine:{styles:{lineColor:this.color}},senkouSpanA:{styles:{lineColor:this.color,
...
!0),b.plotY=b["plot"+c],b.tooltipPos=[b.plotX,b["plot"+c]],b.isNull=!1)})})};f.prototype.drawGraph=function(){var b=this,c=b.points,l=c.length,g=b.options,e=b.graph,f=b.color,B={options:{gapSize:g.gapSize}},z=b.pointArrayMap.length,t=[[],[],[],[],[],[]],m={tenkanLine:t[0],kijunLine:t[1],chikouLine:t[2],senkouSpanA:t[3],senkouSpanB:t[4],senkouSpan:t[5]},k=[],p=b.options.senkouSpan,n=p.color||p.styles.fill,q=p.negativeColor,x=[[],[]],u=[[],[]],Q=0,M,R,O;for(b.ikhMap=m;l--;){var G=c[l];for(M=0;M<z;M++)p=
b.pointArrayMap[M],v(G[p])&&t[M].push({plotX:G.plotX,plotY:G["plot"+p],isNull:!1});q&&l!==c.length-1&&(p=m.senkouSpanB.length-1,G=d(m.senkouSpanA[p-1],m.senkouSpanA[p],m.senkouSpanB[p-1],m.senkouSpanB[p]),M={plotX:G.plotX,plotY:G.plotY,isNull:!1,intersectPoint:!0},G&&(m.senkouSpanA.splice(p,0,M),m.senkouSpanB.splice(p,0,M),k.push(p)))}N(m,function(a,c){g[c]&&"senkouSpan"!==c&&(b.points=t[Q],b.options=w(g[c].styles,B),b.graph=b["graph"+c],b.fillGraph=!1,b.color=f,h.seriesTypes.sma.prototype.drawGraph.call(b),
b["graph"+c]=b.graph);Q++});b.graphCollection&&b.graphCollection.forEach(function(a){b[a].destroy();delete b[a]});b.graphCollection=[];if(q&&m.senkouSpanA[0]&&m.senkouSpanB[0]){k.unshift(0);k.push(m.senkouSpanA.length-1);for(z=0;z<k.length-1;z++){p=k[z];G=k[z+1];l=m.senkouSpanB.slice(p,G+1);p=m.senkouSpanA.slice(p,G+1);if(1<=Math.floor(l.length/2))if(G=Math.floor(l.length/2),l[G].plotY===p[G].plotY){for(O=M=G=0;O<l.length;O++)G+=l[O].plotY,M+=p[O].plotY;G=G>M?0:1}else G=l[G].plotY>p[G].plotY?0:1;
else G=l[0].plotY>p[0].plotY?0:1;x[G]=x[G].concat(l);u[G]=u[G].concat(p)}["graphsenkouSpanColor","graphsenkouSpanNegativeColor"].forEach(function(c,l){x[l].length&&u[l].length&&(R=0===l?n:q,a({indicator:b,points:x[l],nextPoints:u[l],color:R,options:g,gap:B,graph:b[c]}),b[c]=b.graph,b.graphCollection.push(c))})}else a({indicator:b,points:m.senkouSpanB,nextPoints:m.senkouSpanA,color:n,options:g,gap:B,graph:b.graphsenkouSpan}),b.graphsenkouSpan=b.graph;delete b.nextPoints;delete b.fillGraph;b.points=
c;b.options=g;b.graph=e;b.color=f};f.prototype.getGraphPath=function(a){var b=[],c;a=a||this.points;if(this.fillGraph&&this.nextPoints){if((c=h.seriesTypes.sma.prototype.getGraphPath.call(this,this.nextPoints))&&c.length){c[0][0]="L";b=h.seriesTypes.sma.prototype.getGraphPath.call(this,a);c=c.slice(0,b.length);for(var l=c.length-1;0<=l;l--)b.push(c[l])}}else b=h.seriesTypes.sma.prototype.getGraphPath.apply(this,arguments);return b};f.prototype.getValues=function(a,b){var c=b.period,l=b.periodTenkan;
b=b.periodSenkouSpanB;var d=a.xData,e=a.yData,v=e&&e.length||0;a=g(a.xAxis);var f=[],h=[],m;if(!(d.length<=c)&&B(e[0])&&4===e[0].length){var w=d[0]-c*a;for(m=0;m<c;m++)h.push(w+m*a);for(m=0;m<v;m++){if(m>=l){var t=e.slice(m-l,m);t=p(t);t=(t.high+t.low)/2}if(m>=c){var z=e.slice(m-c,m);z=p(z);z=(z.high+z.low)/2;var r=(t+z)/2}if(m>=b){var k=e.slice(m-b,m);k=p(k);k=(k.high+k.low)/2}w=e[m][3];var y=d[m];"undefined"===typeof f[m]&&(f[m]=[]);"undefined"===typeof f[m+c]&&(f[m+c]=[]);f[m+c][0]=t;f[m+c][1]=
z;f[m+c][2]=void 0;f[m][2]=w;m<=c&&(f[m+c][3]=void 0,f[m+c][4]=void 0);"undefined"===typeof f[m+2*c]&&(f[m+2*c]=[]);f[m+2*c][3]=r;f[m+2*c][4]=k;h.push(y)}for(m=1;m<=c;m++)h.push(y+m*a);return{values:f,xData:h,yData:f}}};f.defaultOptions=w(l.defaultOptions,{params:{index:void 0,period:26,periodTenkan:9,periodSenkouSpanB:52},marker:{enabled:!1},tooltip:{pointFormat:'<span style="color:{point.color}">\u25cf</span> <b> {series.name}</b><br/>TENKAN SEN: {point.tenkanSen:.3f}<br/>KIJUN SEN: {point.kijunSen:.3f}<br/>CHIKOU SPAN: {point.chikouSpan:.3f}<br/>SENKOU SPAN A: {point.senkouSpanA:.3f}<br/>SENKOU SPAN B: {point.senkouSpanB:.3f}<br/>'},
tenkanLine:{styles:{lineWidth:1,lineColor:void 0}},kijunLine:{styles:{lineWidth:1,lineColor:void 0}},chikouLine:{styles:{lineWidth:1,lineColor:void 0}},senkouSpanA:{styles:{lineWidth:1,lineColor:void 0}},senkouSpanB:{styles:{lineWidth:1,lineColor:void 0}},senkouSpan:{styles:{fill:"rgba(255, 0, 0, 0.5)"}},dataGrouping:{approximation:"ichimoku-averages"}});return f}(l);f(k.prototype,{pointArrayMap:["tenkanSen","kijunSen","chikouSpan","senkouSpanA","senkouSpanB"],pointValKey:"tenkanSen",nameComponents:["periodSenkouSpanB",
