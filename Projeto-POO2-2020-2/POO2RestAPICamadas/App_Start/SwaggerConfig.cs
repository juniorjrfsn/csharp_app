...
using POO2RestAPICamadas;
using Swashbuckle.Application;
using System.Linq;

[assembly: PreApplicationStartMethod(typeof(SwaggerConfig), "Register")]

namespace POO2RestAPICamadas
{
    /// <summary>
    /// 
    /// </summary>
    public class SwaggerConfig
    {
        ...
        {
            return System.String.Format(@"{0}\Docs\POO2RestAPICamadas.xml", System.AppDomain.CurrentDomain.BaseDirectory);
        }
    }
}
